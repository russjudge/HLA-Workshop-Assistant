...
namespace HLA_Workshop_Assistant
{
    ...
    public static class GridViewColumnHeaderSorter
    {
        ...
        public static readonly DependencyProperty SortEnabledProperty =
          DependencyProperty.RegisterAttached("SortEnabled",
          typeof(bool), typeof(GridViewColumnHeaderSorter), new FrameworkPropertyMetadata(true));
        ...
        static void RemoveSortAdorner(ListView target)
        {
            GridViewColumnHeader _CurSortCol = GetCurrentSortColumn(target);
            SortAdorner _CurAdorner = GetCurrentSortAdorner(target);
            if (_CurSortCol != null)
            {
                AdornerLayer.GetAdornerLayer(_CurSortCol).Remove(_CurAdorner);
                ListCollectionView dataView = CollectionViewSource.GetDefaultView(target.ItemsSource) as ListCollectionView;
